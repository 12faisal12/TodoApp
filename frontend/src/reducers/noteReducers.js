...
export const noteListReducer = (state = {notes:[]}, action)=>{
    switch (action.type) {
        ...
        case NOTE_LIST_FAIL:
            return { loading: false, error: 'failed to load notes' }
        default:
            return state
    }
}
...
export const noteCreateReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case NOTE_CREATE_FAIL:
      return { loading: false, error: "failed to create note" };
    default:
      return state;
  }
};
...
export const noteUpdateReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case NOTE_UPDATE_FAIL:
      return { loading: false, error: 'failed to update note',success:false }
    default:
      return state
  }
}
...
export const noteDeleteReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case NOTE_DELETE_FAIL:
      return { loading: false, error: 'failed to delete note' }
    default:
      return state
  }
}
